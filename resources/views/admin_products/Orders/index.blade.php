	...
	<div class="card">
		<div class="card-body">
			<div class="container-fluid">
				<div class="row">
					<div class="col-12">
						@if(auth()->user()->hasPermission("Agregar-Orders"))
							<a href="/Orders/create" class="btn btn-primary-ws pull-right btn-wd">
					...
					<div class="col-12">
						...
						<table class="table table-bordered table-grid table-general" id="Orders-table" style="width:100%"></table>
					</div>
				</div>
			</div>
		</div>
